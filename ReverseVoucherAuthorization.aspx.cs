...
{
    public partial class ReverseVoucherAuthorization : System.Web.UI.Page
    {
        ...
        {
            // GridView will be populated by SqlDataSource on postback
        }
        ...
        protected void gvIndividualVous_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.gvIndividualVous.SelectedIndex > -1)
            {
                ...
                Response.Redirect("ReverseVoucherAuthorization2.aspx?VouNo=" + vouNum);
            }
        }
    }
}