...
{
    public partial class VoucherReprint2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Session["EPFNum"] != null)
                {
                    ...
                    this.lblClmType.Text = frmtDtObj.getClmType(dtVouDetals.Rows[0][2].ToString());
                    this.lblPaymntType.Text = frmtDtObj.getPaymntType(dtVouDetals.Rows[0][8].ToString());
                    this.lblUser_epf.Text = dtVouDetals.Rows[0][13].ToString();
