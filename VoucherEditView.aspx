...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="edit-table">
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="txtPayeeName" runat="server" Width="350px" />
                <asp:RequiredFieldValidator ID="rfvPayee" runat="server" ControlToValidate="txtPayeeName" ErrorMessage="*" ForeColor="Red" />
            </td>
        </tr>
        <tr>
