...
public partial class lapseLetter002 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            this.litclmno.Text = clmno.ToString();
            ...
            //    if (due > 0) { this.lbllapsdate.Text = due.ToString().Substring(0, 4) + "/" + due.ToString().Substring(4, 2) + "/" + com.ToString().Substring(6, 2); }
            //}
            if (due > 0) { this.litlapseddate.Text = due.ToString().Substring(0, 4) + "/" + due.ToString().Substring(4, 2) + "/" + com.ToString().Substring(6, 2); }
