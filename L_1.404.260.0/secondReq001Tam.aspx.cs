...
public partial class secondReq001Tam : System.Web.UI.Page
{
    #region Variables
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                if (formObj.existRecored(secreqSelect) != 0)
                {
                    ...
                    {
                        txtSecReqDescription.Text = "Nkw; Nfhug;gl;l Mtzq;fspw;F Nkyjpfkhf fPo;Nfhug;gLk; Mtzq;fisAk; vkf;F je;JjTkhW Nfl;Lf;nfhs;fpd;Nwhk;.";
                    }
