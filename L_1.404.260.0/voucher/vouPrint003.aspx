<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vouPrint003.aspx.cs" Inherits="vouPrint003" %>
<%@ PreviousPageType VirtualPath="~/voucher/vouPrint002.aspx"%>
...
<body>
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><span style="font-size: 14pt">Sri Lanka
            Insurance<br />
            <span style="font-size: 12pt">Death Claim Voucher</span><br />
        </span></span></strong>
        <table style="font-size: 10pt; width: 649px; font-family: Arial; font-variant: normal">
            ...
            <asp:Label ID="lblPaytype" runat="server" Font-Names="Trebuchet MS" Font-Size="11pt"
            ...
            <tr>
                ...
                <td style="width: 580px; height: 10px; text-align: left">
                </td>
                <td style="width: 161px; height: 10px; text-align: left">
                </td>
                <td style="width: 152px; height: 10px; text-align: left">
                </td>
                <td style="width: 134px; height: 10px; text-align: left">
                </td>
            </tr>
            <tr>
                <td style="width: 10px; height: 18px">
            ...
            <tr>
                ...
                <td style="width: 511px; text-align: left; height: 18px;">
                    CLASS OF INSURANCE</td>
                <td style="width: 161px; text-align: left; height: 18px;">
                    : LIFE</td>
                <td style="width: 152px; text-align: left; height: 18px;">
                </td>
                <td style="width: 134px; text-align: left; height: 18px;">
                </td>
            </tr>
            <tr>
                <td style="width: 10px; height: 18px;">
            ...
            <tr>
                ...
                <td style="width: 580px; text-align: left" rowspan="2">
                    NET AMOUNT PAYABLE<br />
                    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                    (IN WORDS)</td>
                <td colspan="3" style="vertical-align: middle; text-align: left" rowspan="2">
                    :
            ...
            <tr>
                ...
                <td style="font-size: 9pt; font-family: 'Trebuchet MS'; width: 161px; height: 10px; text-align :center; ">
                ...
                <td colspan="2" style="width: 152px; height: 10px; text-align: center; padding-left:20px">
                    <%--<asp:Label ID="lblSignature" runat="server" Text="" Visible="false"> </asp:Label>--%>
                
                </td>
            </tr>
            <tr style ="height:2px; line-height:0px">
                <td style="width: 10px;">
                </td>
            ...
            <tr>
                ...
                <td style="width: 161px; height: 18px; text-align: left;padding-left:10px">
            ...
            <tr>
                ...
                <td colspan="3" style="height: 18px; text-align: left">
                    :
                    <asp:Label ID="lblad4" runat="server" Width="400px"></asp:Label></td>
            </tr>
            <tr>
                <td style="width: 10px; height: 18px">
                </td>
                ...
                <td colspan="5" style="height: 18px">
                    <span style="font-family: Courier New">
                        <asp:Button ID="btnprint" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                            OnClick="btnprint_Click" OnClientClick="cForm1(this.form1)" PostBackUrl="~/voucher/vouPrint004.aspx"
                            Text=" Print " /><asp:Button ID="btnexit" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
