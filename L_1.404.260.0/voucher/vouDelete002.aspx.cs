...
public partial class voucher_vouDelete002 : System.Web.UI.Page
{
    ...
    {
        bool Checkflag1 = true; //Rajitha Lakshan 42650
        bool Checkflag2 = true; //Rajitha Lakshan 42650
        bool Checkflag3 = true; //Rajitha Lakshan 42650
        bool Checkflag4 = true; //Rajitha Lakshan 42650
        bool Checkflag5 = true; //Rajitha Lakshan 42650
        ...
        try
        {
            ...
            if (payee.Equals("NOM"))
            {
                ...
                else { /*this.lblmessage.Visible = true;*/ Checkflag1 = false; }  //Rajitha Lakshan 42650
            ...
            else if (payee.Equals("LHI") || payee.Equals("ML") || payee.Equals("SL"))
            {
                ...
                else { /*this.lblmessage.Visible = true;*/  Checkflag2 = false; } //Rajitha Lakshan 42650
            ...
            else if (payee.Equals("ASI"))
            {
                ...
                else { /*this.lblmessage.Visible = true;*/ Checkflag3 = false; } //Rajitha Lakshan 42650
            ...
            else if (payee.Equals("LPT"))
            {
                ...
                else { /*this.lblmessage.Visible = true;*/ Checkflag4 = false; } //Rajitha Lakshan 42650
            ...
            else { /*this.lblmessage.Visible = true;*/ Checkflag5 = false; } //Rajitha Lakshan 42650
            ...
            slivp.Fetch(polno, dm, claimno, "vouDelete003.aspx", MOS);
            ...
            if (Checkflag1 == false && Checkflag2 == false && Checkflag3 == false && Checkflag4 == false && Checkflag5 == false)  //Rajitha Lakshan 42650
            {
    ...
    public ICollection CreateDataSource()
    {
        ...
        {
            linkUrl = "<a  href=vouDelete003.aspx?vouno=" + vpf.Vouno + "&payee=" + vpf.Payee + "&amount=" + vpf.Share + "&polno=" + polno.ToString() + "&mos=" + MOS + "&clmno=" + claimno + "&exgrshare=" + vpf.ExgraciaShare + "&slicflag=0&vouType=D&delete_Type=Dth>" + vpf.Vouno + "</a>";
            dr = dt.NewRow();
    ...
    public ICollection CreateDataSource2()
    {
        ...
        {
            linkUrl = "<a  href=vouDelete003.aspx?vouno=" + vpf.Vouno + "&payee=" + vpf.Payee + "&amount=" + vpf.Share + "&polno=" + polno.ToString() + "&mos=" + MOS + "&clmno=" + claimno + "&exgrshare=" + vpf.ExgraciaShare + "&slicflag=0&vouType=D&delete_Type=ADB>" + vpf.Vouno + "</a>";
            dr = dt.NewRow();
