<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vouDetEdit001.aspx.cs" Inherits="vouDetEdit001" %>
...
<body>
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><br />
            ...
            Insurance<br />
                        </span>Death Claim Voucher Deatils&nbsp; Edit.</td>
                ...
                <tr>
                    ...
                    <td style="text-align: left" colspan="2">
                        <span>
                            <asp:TextBox ID="txtpolno" runat="server" MaxLength="8" Font-Names="Trebuchet MS" Font-Size="10pt" Width="113px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtpolno"
                            ErrorMessage="Please Give the Policy Number" Font-Bold="False" Font-Size="10pt"
                            Width="209px" Display="Dynamic"></asp:RequiredFieldValidator><asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="test"
                ...
                <tr>
                    ...
                    <td style="width: 183px; height: 21px; text-align: left">
                    ...
                    <td style="width: 220px; height: 21px; text-align: left">
                        <span style="font-size: 12pt"><strong> </strong>
                            <asp:DropDownList ID="ddlMOS" runat="server" Font-Names="Trebuchet MS" Font-Size="10pt" Width="123px">
                ...
                <tr>
                    ...
                    <td style="width: 220px; height: 21px; text-align: left">
                        <asp:Button ID="btnsubmit" runat="server" Font-Bold="False" Font-Names="Trebuchet MS"
                            OnClick="btnsubmit_Click" PostBackUrl="~/voucher/vouDetEdit002.aspx" Text="--Submit--" Font-Size="10pt" />
                        <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Size="10pt" ForeColor="Blue"
                            NavigateUrl="~/voucher/vouPrintMain.aspx" Font-Names="Trebuchet MS"><<--Back</asp:HyperLink></td>
                    <td style="width: 79px; height: 21px">
                    </td>
                </tr>
                <tr>
