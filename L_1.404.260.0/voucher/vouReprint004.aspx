<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vouReprint004.aspx.cs" Inherits="vouReprint004" %>
<%@ Reference Page="~/EPage.aspx" %>
<%@ Reference Page="~/readAmountFunction.aspx" %>
<%@ PreviousPageType VirtualPath="~/voucher/vouReprint003.aspx"%>
    ...
    <div style="text-align: center">
        <table style="font-size: 10pt; width: 649px; font-family: Arial; font-variant: normal">
            ...
            <tr style="font-size: 10pt">
                ...
                <td style="width: 1002px; height: 18px; text-align: left">
                    <span style="font-size: 8pt">BANK ACCOUNT NO.</span></td>
            ...
            <tr style="font-size: 10pt">
             ...
             <tr>
                ...
                <td colspan="2" style="width: 152px; height: 10px; text-align: left; padding-left: 30px;">
                <%--<asp:Label ID="lblSignature" runat="server" Text="" Visible="false"> </asp:Label>--%>
                </td>
            </tr>
            ...
            <tr style="font-size: 10pt">
                ...
                <td style="width: 161px; height: 18px; text-align :left; padding-left: 10px">
                    ...
                    <br />
                    <asp:Label ID="lbladdepf" runat="server" Text="" Visible="false"> </asp:Label></td>
