    ...
    <div style="text-align: center">
        ...
        <table style="width: 633px">
            <tr>
                ...
                <td style="width: 100px; height: 18px; background-color: #f0f0f0">
                </td>
                <td style="width: 100px; height: 18px; background-color: #f0f0f0">
                </td>
                <td style="width: 130px; height: 18px; background-color: #f0f0f0">
                </td>
                <td style="width: 140px; height: 18px; background-color: #f0f0f0">
                </td>
                <td style="width: 130px; height: 18px; background-color: #f0f0f0">
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 130px; height: 18px; text-align: center">
                ...
                <td style="width: 140px; height: 18px; text-align: center">
                ...
                <td style="width: 130px; height: 18px; text-align: center">
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" Font-Names="Trebuchet MS"
                        Font-Size="10pt" NavigateUrl="~/voucher/vouDelete001.aspx">Voucher Delete</asp:HyperLink></td>
            </tr>
            <tr>
                <td style="width: 26px; height: 18px; background-color: #f0f0f0; text-align: left">
                </td>
                <td style="width: 100px; height: 18px; background-color: #f0f0f0; text-align: center">
                </td>
                <td style="width: 100px; height: 18px; background-color: #f0f0f0; text-align: center">
                </td>
                <td style="width: 130px; height: 18px; background-color: #f0f0f0; text-align: center">
                </td>
                <td style="width: 140px; height: 18px; background-color: #f0f0f0; text-align: left">
                </td>
                <td style="width: 130px; height: 18px; background-color: #f0f0f0; text-align: left">
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 140px; height: 18px; text-align: right">
                </td>
                <td style="width: 130px; height: 18px; text-align: right">
                </td>
            </tr>
        </table>
