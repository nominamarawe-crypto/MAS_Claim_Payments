<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vouAuth001.aspx.cs" Inherits="vouAuth001" %>
...
<body>
    ...
    <div style="text-align: center">
        ...
        <table style="font-weight: bold; font-size: 12pt; width: 603px; font-family: Trebuchet MS">
            ...
            Insurance<br />
                    </span>Death Claim Voucher Authorization.</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align: left" colspan="2">
                    <span>
                        <asp:TextBox ID="txtpolno" runat="server" MaxLength="8" Font-Names="Trebuchet MS" Font-Size="10pt" Width="111px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtpolno"
            ...
            <tr>
                ...
                <td style="width: 220px; height: 21px; text-align: left">
                    <span style="font-size: 12pt"><strong> </strong>
                        <asp:DropDownList ID="ddlMOS" runat="server" Font-Names="Trebuchet MS" Font-Size="10pt" Width="110px">
            ...
            <tr>
                ...
                <td style="width: 220px; height: 21px; text-align: left">
                    <asp:Button ID="btnsubmit" runat="server" Font-Bold="False" Font-Names="Trebuchet MS"
                        OnClick="btnsubmit_Click" PostBackUrl="~/voucher/vouAuth002.aspx" Text="--Submit--" Font-Size="10pt" Width="98px" />
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="2">
                    <asp:CustomValidator ID="cv1" runat="server" Font-Bold="False" ValidationGroup="sb"
                        Width="417px" Font-Size="10pt" OnServerValidate="cv1_ServerValidate"></asp:CustomValidator></td>
                <td style="width: 79px">
                </td>
            </tr>
            <tr style="font-size: 12pt">
