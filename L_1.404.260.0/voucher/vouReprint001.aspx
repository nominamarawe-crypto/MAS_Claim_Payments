...
<body>
    ...
    <div style="text-align: center">
        <table style="font-weight: bold; font-size: 12pt; width: 603px; font-family: Trebuchet MS">
            ...
            Insurance<br />
                    </span>Death Claim Voucher Reprinting</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align: left" colspan="2">
                    <span>
                        <asp:TextBox ID="txtpolno" runat="server" MaxLength="8" Font-Names="Trebuchet MS" Font-Size="10pt" Width="107px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtpolno"
            ...
            <tr style="font-size: 12pt">
                <td colspan="4" style="height: 21px; background-color: #f0f0f0; text-align: left">
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="width: 220px; height: 21px; text-align: left">
                    <span style="font-size: 12pt"><strong> </strong>
                        <asp:DropDownList ID="ddlMOS" runat="server" Font-Names="Trebuchet MS" Font-Size="10pt" Width="104px">
            ...
            <tr>
                ...
                <td style="width: 220px; height: 21px; text-align: left">
                    <asp:Button ID="btnsubmit" runat="server" Font-Bold="False" Font-Names="Trebuchet MS"
                        OnClick="btnsubmit_Click" PostBackUrl="~/voucher/vouReprint002.aspx" Text="--Submit--" Font-Size="10pt" />
