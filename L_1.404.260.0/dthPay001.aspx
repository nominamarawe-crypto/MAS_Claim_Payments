<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dthPay001.aspx.cs" Inherits="dthPay001" %>
<%@ PreviousPageType VirtualPath="~/dthPro003.aspx"%>
    ...
    <div style="text-align: center">
        ...
        <table style="width: 603px; font-size: 12pt; font-family: 'Trebuchet MS';">
            ...
            Sri Lanka Insurance<br />
                    </span>Death Claim Payment Memo and Distribution</strong></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 220px; height: 22px; background-color: #ffffff; text-align: left">
                    <asp:Button ID="btnsubmit" runat="server" OnClick="btnsubmit_Click"
                        Text="Submit" Font-Bold="True" Font-Names="Trebuchet MS" Width="106px" PostBackUrl="~/dthPay020.aspx" />
