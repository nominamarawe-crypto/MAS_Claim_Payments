<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cvouPrint001.aspx.cs" Inherits="cvouPrint001" %>
...
<body>
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><span style="font-size: 14pt">Sri Lanka
            Insurance<br />
        </span>Child Protection Annual Payment Voucher Printing<br />
        </span></strong>
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="2">
                    <asp:Button ID="btnsubmit" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                        OnClick="btnsubmit_Click" Text="Submit" /><asp:Button ID="btnrest" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
