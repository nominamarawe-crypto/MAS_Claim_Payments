...
public partial class vouPrint003 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            { 
                ...
                {
                    dm.connclose();
                    throw new Exception("No Voucher Details Availbale or Voucher/Cheque Already Printed!");
                }
        ...
        else 
        {
            ...
            //name = ViewState["nameQstr"].ToString();
