<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cvouPrint002.aspx.cs" Inherits="cvouPrint002" %>
<%@ PreviousPageType VirtualPath="~/childProtVou/cvouPrint001.aspx"%>
...
<body>
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"/><span/><span style="font-family: Trebuchet MS">
            ...
            Insurance<br/>
            </span>Child Protection Annual Payment Voucher<table style="font-weight: normal;
                font-size: 10pt; width: 649px; font-family: Arial; font-variant: normal">
                <tr>
            ...
            : LIFE</td>
                ...
                <tr style="font-size: 10pt">
                    ...
                    <td colspan="3" style="font-size: 8pt; height: 18px; text-align: left">
                        :
                        <asp:Label ID="lblacctno" runat="server" Width="400px" Font-Size="10pt"></asp:Label></td>
                </tr>
                <tr style="font-size: 8pt">
                    <td style="width: 10px; height: 18px">
                    </td>
                    ...
                    <td colspan="3" style="height: 18px; text-align: left">
                        :
                        <asp:Label ID="lblnameofpayee" runat="server" Width="400px" Font-Size="10pt"></asp:Label></td>
                </tr>
                <tr style="font-size: 10pt">
                    <td style="width: 10px; height: 18px">
                    </td>
                ...
                <tr style="font-size: 10pt">
                    ...
                    <td style="width: 161px; height: 10px; font-size: 9pt; font-family: 'Trebuchet MS'; text-align :center;">
                ...
                <tr>
                    ...
                    <td style="width: 161px; height: 18px; text-align: left">
                        : 
                        <asp:Label ID="lblaccode" runat="server" Text="002118"></asp:Label></td>
                    <td style="width: 152px; height: 18px; text-align: left">
                        ACOUNT CODE</td>
                    <td style="width: 134px; height: 18px; text-align: left">
                        : 002142</td>
                    ...
                    <td colspan="5" style="height: 18px">
                        <span style="font-family: Courier New">
                            <asp:Button ID="btnprint" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                                OnClientClick="cForm1(this.form1)"
                                Text=" Print " PostBackUrl="~/ChildProt/cvouPrint003.aspx" /><asp:Button ID="btnexit" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                        ...
                        <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" Font-Names="Trebuchet MS"
                            Font-Size="10pt" ForeColor="Blue" NavigateUrl="~/voucher/vouPrintMain.aspx"><<--Back</asp:HyperLink></span></td>
                </tr>
                <tr>
                    <td style="width: 10px; height: 18px">
                    </td>
...
function cForm1(form)
{
 ...
 form1.target='myWin';
 form1.action='cvouPrint003.aspx';
