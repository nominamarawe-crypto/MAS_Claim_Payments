...
/// <summary>
/// Summary description for DthPartPaid
/// </summary>
[Serializable]
public class DthPartPaid
{
    ...
    private List<DthPartPaid> dthPartPaidlistMaker = new List<DthPartPaid>();
    public void Fetch(int Thestartdate, int Theenddate)
    {
        ...
        try
        {
            ...
            string dthrefsel = "select  drpolno,drmos,drclmno, drgrossclm, drnetclm,  SMASS_PVAL, DRSWARNAJAYA, DRFUNERALEXP, DRFPU, DRACCBF,PAYEE from lphs.dthref where   MEMOAPRV='Y' and completed is null and payee is not null  and  DENTDT  between " + startdate + "  and " + enddate + "";
            if (dm.existRecored(dthrefsel) != 0)
            {
                ...
                while (dthrefreader.Read())
                {
                   ...
                   if (payee.Equals("LHI"))
                    ...
                    noofClaims = DthPartPaidListMake.Count + 1;
                    //TotalLiableAmt += totliableamt;
                    A.TOTLiabeAmt = TotalLiableAmt;
                    DthPartPaidListMake.Add(A);
    ...
    public List<DthPartPaid> DthPartPaidListMake
    {
        get { return dthPartPaidlistMaker; }
        set { dthPartPaidlistMaker = value; }
    }
    public int Polno
    {
        get { return polno; }
