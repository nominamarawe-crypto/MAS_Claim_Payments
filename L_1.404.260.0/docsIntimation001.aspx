<%@ Page Language="C#" AutoEventWireup="true" CodeFile="docsIntimation001.aspx.cs" Inherits="docsIntimation001" %>
...
<body>
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><span style="font-size: 14pt">Sri Lanka Insurance<br />
        </span>Death Intimation Stage Documents</span></strong><br />
        <table style="font-size: 10pt; width: 543px; font-family: 'Trebuchet MS'">
            ...
            <tr>
                ...
                <td style="font-size: 10pt; width: 102px">
                </td>
            </tr>
            <tr style="font-size: 10pt">
                ...
                <td colspan="3" style="height: 22px; background-color: #f0f0f0; text-align: left">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtpolno"
                        ErrorMessage="Please Give the Policy Number" Font-Bold="True" Font-Names="Trebuchet MS"
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:Button ID="btnsubmit" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                        OnClick="btnsubmit_Click" PostBackUrl="~/docsIntMain.aspx" Text="Submit" />
