...
public partial class Intofdth2503Sin : System.Web.UI.Page
{
    private int polno;
    private string MOF;
                ...
                //{*/
                    ...
                    if (formObj.existRecored(dclmaddressSelect) != 0)
                    {
                        ...
                        while (dclmAdReader.Read())
                        {
                            ...
                            if (INDEX == 0)
                            {
                                this.litname.Text = Address2[2].ToString();
                                this.litad1.Text = Address2[3].ToString();
                                this.litad2.Text = Address2[4].ToString();
                                this.litad3.Text = Address2[5].ToString();
                                this.litad4.Text = Address2[6].ToString();
                            }
                            if (Address2[2].ToString() != "")
                            {
            ...
            if (RecordNumber == 19 || RecordNumber == 20 || RecordNumber == 21)
            {
                if (RecordNumber == 19 || RecordNumber == 20)
                {
                    for (int i = 0; i < 7; i++)
                    {
                        ...
                        tblOthDoc.Rows[i].Cells[0].HorizontalAlign = HorizontalAlign.Justify;
                        tblOthDoc.Rows[i].Cells[1].HorizontalAlign = HorizontalAlign.Justify;
                        tblOthDoc.Rows[i].Cells[0].VerticalAlign = VerticalAlign.Top;
                        tblOthDoc.Rows[i].Cells[1].VerticalAlign = VerticalAlign.Top;


                        TableRow tr = new TableRow();
                        tblOthDoc.Rows.Add(tr);
        ...
        for (int a = 0; a <  ReqcodeList.Count; a++)
        {
            if (int.Parse(ReqcodeList[a].ToString()) == 19)
            {
                for (int i = 0; i < 7; i++)
                {
                    ...
                    txtname2 = (TextBox)tblOthDoc.FindControl("DyTextBox9" + i.ToString());
                    if (txtname2.Text != "")
                    {
            ...
            if (int.Parse(ReqcodeList[a].ToString()) == 20)
            {
                ...
                {
                    TextBox txtname2 = new TextBox();
                    txtname2 = (TextBox)tblOthDoc.FindControl("DyTextBox10" + i.ToString());
                    if (txtname2.Text != "")
                    {
            ...
            if (int.Parse(ReqcodeList[a].ToString()) == 21)
            {
                for (int j = 0; j < 2; j++)
                {
                    ...
                    {
                        TextBox txtname2 = new TextBox();
                        txtname2 = (TextBox)tblOthDoc.FindControl("DyTextBox20" + j.ToString() + i.ToString());
                        if (txtname2.Text != "")
                        {
                            if (j == 0)
                            {
