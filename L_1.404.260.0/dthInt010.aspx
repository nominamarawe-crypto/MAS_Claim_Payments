<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dthInt010.aspx.cs" Inherits="dthInt010" %>
...
<body>
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><span style="font-size: 14pt">
        </span></span></strong><table style="font-size: 10pt; width: 501px; font-family: 'Trebuchet MS'">
            <tr>
            ...
            Insurance<br />
                    </span><span style="font-size: 12pt">Death Claim Intimation</span></strong></td>
            </tr>
            ...
            <tr style="font-size: 10pt">
                ...
                <td style="font-size: 10pt; text-align: left" colspan="2">
                    <span><strong><span style="font-size: 12pt"></span></strong><asp:TextBox ID="txtpolno" runat="server" MaxLength="8" Font-Names="Trebuchet MS" Font-Size="10pt" Width="125px" ></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtpolno"
                        ...
                        Width="197px" Display="Dynamic"></asp:RequiredFieldValidator>
            ...
            <tr style="font-size: 10pt">
                ...
                <td style="width: 220px; height: 21px; text-align: left">
                    <span><span style="font-size: 12pt"><strong></strong></span><asp:DropDownList ID="ddlMOS" runat="server" AutoPostBack="True" Font-Names="Trebuchet MS" Font-Size="10pt" Width="123px" >
            ...
            <tr style="font-size: 10pt">
                ...
                <td colspan="2" style="height: 21px; text-align: left">
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Size="10pt" ForeColor="Blue"
                        NavigateUrl="~/Home.aspx" Font-Names="Trebuchet MS" Width="99px"><<--Back</asp:HyperLink></td>
            </tr>
            <tr>
                <td style="width: 57px; height: 22px; background-color: #f0f0f0">
                </td>
