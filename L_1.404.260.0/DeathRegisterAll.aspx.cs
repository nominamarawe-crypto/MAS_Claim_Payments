...
public partial class TEST2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            //query = "   select  DCONFDAT   as confirmed_date ,  DRCLMNO as Claim_No, DRPOLNO as Policy_No , DNOD  as Name, address " +    //--4  
            ...
            SetDateRange();
            string SubString = "  where  dconfdat between " + fromDate + " and  " + toDate + "    ORDER BY dconfdat ASC,DRCLMNO ASC ";
            //string SubString = "  where  to_char(DENTDATE,'yyyymmdd') between '" + fromDate + "' and  '" + toDate + "'    ORDER BY DRCLMNO ";
            ...
            ViewState["DSS"] = ds;
            //BindGridView();
            //ViewState["GV"] = GridViewDeathRegisterView;
        }
        else {
           ds=(DataSet) ViewState["DSS"];
           //BindGridView();
           //ViewState["GV"] = GridViewDeathRegisterView;
        }
    ...
    protected void GridViewDeathRegisterView_PageIndexChanging1(object sender, GridViewPageEventArgs e)
    {
