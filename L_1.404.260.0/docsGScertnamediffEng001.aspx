<%@ Page Language="C#" AutoEventWireup="true" CodeFile="docsGScertnamediffEng001.aspx.cs" Inherits="docsGScertnamediffEng001" %>
        ...
        <table style="width: 637px">
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="4" style="height: 20px; text-align: left">
                    <span style="font-size: 12pt; font-family: 'Times New Roman'; mso-fareast-font-family: 'Times New Roman';
                        mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">
                        <strong><span style="text-decoration: underline">On the Life of Mr. /Mrs. </span></strong>
                        <asp:Label ID="lblnameofdead" runat="server" Font-Size="11pt" Font-Underline="True"
                            Width="279px"></asp:Label><span style="font-size: 12pt; font-family: 'Times New Roman';
                                text-decoration: underline; mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US;
                                mso-fareast-language: EN-US; mso-bidi-language: AR-SA"><strong>(decd)</strong></span></span></td>
            ...
            <tr>
                ...
                <td colspan="4" style="height: 20px; text-align: left">
                    1.
                    <asp:TextBox ID="txtname1" runat="server" Width="425px"></asp:TextBox></td>
                <td style="width: 20px; height: 20px">
                </td>
            </tr>
            <tr>
                ...
                <td colspan="4" style="height: 20px; text-align: left">
                    2.
                    <asp:TextBox ID="txtname2" runat="server" Width="425px"></asp:TextBox></td>
                <td style="width: 20px; height: 20px">
                </td>
            </tr>
            <tr>
                ...
                <td colspan="4" style="height: 20px; text-align: left">
                    3.
                    <asp:TextBox ID="txtname3" runat="server" Width="425px"></asp:TextBox></td>
                <td style="width: 20px; height: 20px">
                </td>
            </tr>
            <tr style="font-size: 12pt">
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="4" style="height: 20px; text-align: left">
                    <p class="MsoNormal" style="margin: 0in 0in 0pt; text-align: justify">
                        <?xml namespace="" ns="urn:schemas-microsoft-com:office:smarttags" prefix="st1" ?><?xml namespace="" prefix="ST1" ?><st1:country-region></st1:country-region><st1:place></st1:place><b style="mso-bidi-font-weight: normal">SRI LANKA</b><b style="mso-bidi-font-weight: normal">INSURANCE CORPORATION LIFE LTD<?xml
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="4" style="height: 20px; text-align: center">
                    <asp:Button ID="btnPrint" runat="server" Font-Bold="True" Font-Italic="False" Font-Names="Trebuchet MS"
                        Text=" Print " OnClick="btnPrint_Click" PostBackUrl="~/docsGScertnamediffEng002.aspx" /></td>
                <td style="width: 20px; height: 20px">
                </td>
            </tr>
            <tr style="font-size: 12pt">
