...
public partial class secondReq001 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ChechedBtn == 2)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Second_Requirment_Letter_English" + polno + ".doc");
    ...
    private void CreateDynTable(string reqcode, string req, int rowNumber, int RecordNumber)
    {
        ...
        //{
            ...
            if (RecordNumber == 21)
            {
                ...
                string lifeAssNom2Name = ""; 
                for (int i = 0; i < 7; i++)
                {
                    if (Ass_Nomihg.Count >= (i + 1))
                    { 
                        lifeAssNom2Name = Ass_Nomihg[i].ToString();
                    }
