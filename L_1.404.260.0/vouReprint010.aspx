<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vouReprint010.aspx.cs" Inherits="vouReprint010" %>
<%@ PreviousPageType VirtualPath="~/vouReprint001.aspx"%>
...
<body style="text-align: center">
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><span style="font-size: 14pt">Sri Lanka
            Insurance<br />
        </span>Surrender Voucher Reprinting</span></strong><br />
