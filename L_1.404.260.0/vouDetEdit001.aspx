...
<body>
    ...
    <div style="text-align: center">
        ...
        <table style="font-weight: bold; font-size: 12pt; width: 501px; font-family: Trebuchet MS">
            ...
            Insurance<br />
                    </span>Surrender Voucher Details Edit</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 224px; text-align: left; height: 21px;">
                    <span style="font-weight: normal; font-size: 10pt">Policy Number</span></td>
                <td style="text-align: left; height: 21px;" colspan="2">
                    <span>
                        <asp:TextBox ID="txtpolno" runat="server" MaxLength="8" Font-Bold="False" Font-Names="Trebuchet MS" Font-Size="10pt"></asp:TextBox>
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="2" style="height: 21px; background-color: #ffffff; text-align: left">
                    <asp:Button ID="btnsubmit" runat="server" Font-Bold="False" Font-Names="Trebuchet MS"
                        OnClick="btnsubmit_Click" PostBackUrl="~/vouDetEdit010.aspx" Text="--Submit--" ValidationGroup="sb" Width="112px" />
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Size="10pt" ForeColor="Blue"
                        NavigateUrl="~/vouMain.aspx" Font-Names="Trebuchet MS" Width="69px"><<--Back</asp:HyperLink></td>
            </tr>
            <tr style="font-size: 12pt">
                <td style="width: 57px; height: 21px; background-color: #f0f0f0">
                </td>
                <td style="width: 224px; height: 21px; background-color: #f0f0f0">
                </td>
