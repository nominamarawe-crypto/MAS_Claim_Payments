...
<%@ PreviousPageType VirtualPath="~/voucher/vouReprint002.aspx"%>
    ...
    <div style="text-align: center">
        ...
        <table style="font-size: 10pt; width: 649px; font-family: Arial; font-variant: normal">
            <tr>
                ...
                <td colspan="4" style="height: 18px">
                    <asp:Label ID="lblPaytype" runat="server" Font-Names="Trebuchet MS" Font-Size="11pt"
                        Text="VOUCHER FOR PAYMENT OF DEATH CLAIM"></asp:Label></td>
            </tr>
            <tr>
                <td style="width: 10px; height: 18px">
                </td>
            ...
            <tr style="font-size: 10pt">
                ...
                <td colspan="2" style="font-size: 9pt; font-family: 'Trebuchet MS'; width: 161px; height: 10px; text-align :center;">
                <%--<asp:Label ID="lblSignature" runat="server" Text="" Visible="false"> </asp:Label>--%>
            ...
            <tr style="font-size: 10pt">
                ...
                <td style="width: 161px; height: 18px; text-align :left; padding-left: 30px">
                ...
                <td colspan="2" style="width: 161px; height: 18px; text-align :left; padding-left: 50px">
            ...
            <tr style="font-size: 10pt">
                ...
                <td colspan="3" style="height: 18px; text-align: left">
                    ...
                    <asp:Panel runat="server" ID="dot3" Visible="true">
                    : ..........................................................
                    </asp:Panel>
                ...
                <td colspan="5" style="height: 18px">
                    <span style="font-family: Courier New">
                        <asp:Button ID="btnprint" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                            OnClick="btnprint_Click" OnClientClick="cForm1(this.form1)" PostBackUrl="~/voucher/vouReprint004.aspx"
