<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DischargeCvrLetter002.aspx.cs" Inherits="letters_DischargeCvrLetter" %>
<%@ PreviousPageType VirtualPath="~/DischargeCvrLetter.aspx"%>
        ...
        <table style="width: 700px; font-size: 10pt; font-family: 'Trebuchet MS';">
            ...
            <tr>
                ...
                <td style="height: 10px; font-family: Trebuchet MS;" colspan="2">
                    <p class="MsoNormal" style="margin: 0in 0in 0pt">
                        <b style="mso-bidi-font-weight: normal"><span style="font-size: 12pt">Registered Post</span><span
                            style="mso-no-proof: yes"><?xml namespace="" ns="urn:schemas-microsoft-com:office:office"
                                prefix="o" ?><o:p></o:p></span></b></p>
                </td>
                <td style="height: 10px; font-family: Trebuchet MS; font-size: 10pt;" colspan="2">
                    <p class="MsoNormal" style="margin: 0in 0in 0pt">
                        <span><strong>“WITHOUT PREJUDICE”<o:p></o:p></strong></span></p>
                </td>
            </tr>
            ...
            <tr style="font-size: 10pt">
                ...
                <td style="height: 9px" colspan="2">
                    <p class="MsoNormal" style="margin: 0in 0in 0pt">
                        <span style="font-family: 'Trebuchet MS'">Our Ref:L/Claims/1/<asp:Literal ID="litclm"
                ...
                <td style="height: 9px" colspan="2">
                    <span style="text-decoration: underline; mso-fareast-font-family: 'Times New Roman';
                        ...
                        mso-fareast-language: EN-US"><strong style="font-size: 10pt; font-family: 'Trebuchet MS';
                            text-decoration: underline">Life <span style="mso-spacerun: yes">&nbsp;</span>Policy<span
                ...
                <td style="height: 9px" colspan="2">
                    <span style="font-size: 12pt; font-family: 'Times New Roman'; text-decoration: underline;
                        ...
                        <strong style="font-size: 10pt; font-family: 'Trebuchet MS'; text-decoration: underline">
                            On the Life of&nbsp;
                            <asp:Literal ID="litdesname" runat="server"></asp:Literal></strong></span></td>
            ...
            <tr style="font-size: 10pt">
                ...
                <td colspan="3" style="height: 9px">
                    <p class="MsoNormal" style="margin: 0in 0in 0pt; text-align: justify">
                        <span style="font-family: 'Trebuchet MS'">We have pleasure in informing you that we
                            have admitted our liability under the above policy according to the policy condition
                            applicable.</span></p>
                </td>
                <td style="width: 100px; height: 9px">
                </td>
            ...
            <tr style="font-size: 10pt">
                ...
                <td style="height: 9px; font-family: Trebuchet MS;" colspan="3">
                    <p class="MsoNormal" style="margin: 0in 0in 0pt; text-align: justify">
                        In order to enable us to settle the claim, we request you to return us the enclosed
                        forms of Discharge receipt and Important notice duly completed by you.</p>
                </td>
                <td style="width: 100px; height: 9px">
                </td>
            </tr>
            ...
            <tr style="font-size: 10pt">
                <td colspan="1" style="width: 34px; font-family: Trebuchet MS; height: 9px; text-align: justify">
                </td>
                <td style="height: 9px; font-family: Trebuchet MS; text-align: justify;" colspan="3">
                    <p class="MsoNormal" style="margin: 0in 0in 0pt; text-align: justify">
                        Your prompt attention in this regard will help us to settle the claim at our earliest.
                    </p>
                    <span style="mso-fareast-font-family: 'Times New Roman'; mso-bidi-font-family: 'Times New Roman';
                        mso-bidi-language: AR-SA; mso-ansi-language: EN-US; mso-fareast-language: EN-US">
                        Thanking you,</span></td>
                <td style="width: 100px; height: 9px">
                </td>
            </tr>
            <tr style="font-size: 10pt">
            ...
            <tr style="font-size: 10pt">
                ...
                <td style="width: 120px; font-family: Trebuchet MS; height: 9px">
                    <p class="MsoNormal" style="margin: 0in 0in 0pt">
                        <?xml namespace="" ns="urn:schemas-microsoft-com:office:smarttags" prefix="st1" ?><st1:country-region w:st="on"><st1:place w:st="on"><B style="mso-bidi-font-weight: normal">Sri 
      Lanka</B></st1:place></st1:country-region><b style="mso-bidi-font-weight: normal">Insurance Corporation Life Ltd<o:p></o:p></b></p>
                </td>
