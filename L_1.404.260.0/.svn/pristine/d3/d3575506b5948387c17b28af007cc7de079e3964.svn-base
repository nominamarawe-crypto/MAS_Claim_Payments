<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vouDelete001.aspx.cs" Inherits="voucher_vouDelete001" %>
...
<body>
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><br />
            ...
            Insurance<br />
                        </span>Death Claim Voucher Delete.</td>
                ...
                <tr>
                    ...
                    <td style="width: 220px; height: 21px; text-align: left">
                        <asp:Button ID="btnsubmit" runat="server" Font-Bold="False" Font-Names="Trebuchet MS"
                            OnClick="btnsubmit_Click" PostBackUrl="~/voucher/vouDelete002.aspx" Text="--Submit--" Font-Size="10pt" />
