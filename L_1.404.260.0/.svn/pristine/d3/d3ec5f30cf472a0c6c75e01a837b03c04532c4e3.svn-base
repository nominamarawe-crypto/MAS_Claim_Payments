<%@ Page Language="C#" AutoEventWireup="true" CodeFile="paymentDistn002.aspx.cs" Inherits="paymentDistn002" %>
<%@ PreviousPageType VirtualPath="~/paymentDistn001.aspx"%>
            ...
            <table style="font-size: 10pt; width: 651px; font-family: 'Trebuchet MS';">
                ...
                <tr>
                    <td colspan="5" style="height: 20px">
                        ...
                        </span>Death Calim Distribution</span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="height: 20px" colspan="5">
                        <asp:Button ID="cmdPayee" runat="server" Height="26px" Text="More Payees" Visible="False" OnClick="cmdPayee_Click" />
                        ...
                        <asp:Button ID="btnnext" runat="server" Font-Bold="False" Font-Names="Trebuchet MS" Text="--Next--" OnClick="btnnext_Click" Font-Size="10pt" />
