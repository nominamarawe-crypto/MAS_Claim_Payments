<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vouDelete002.aspx.cs" Inherits="voucher_vouDelete002" %>
<%@ PreviousPageType VirtualPath="~/voucher/vouDelete001.aspx"%>
...
<body>
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><span style="font-size: 14pt">Sri Lanka
            ...
            <br />
            <asp:Label ID="Label1" runat="server" Text="ADB Vouchers" Visible="False"></asp:Label><asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge"
                BorderWidth="2px" CellPadding="3" CellSpacing="1" Font-Bold="False" GridLines="None"
                Style="font-size: 10pt; font-family: 'Trebuchet MS'" Width="618px">
                <PagerSettings Visible="False" />
            ...
            <br />
            <asp:Label ID="lblSlicvou" runat="server" Text="SLIC Vouchers" Visible="False"></asp:Label>&nbsp;<asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge"
                BorderWidth="2px" CellPadding="3" CellSpacing="1" Font-Bold="False" GridLines="None"
                Style="font-size: 10pt; font-family: 'Trebuchet MS'" Width="618px">
                <PagerSettings Visible="False" />
            ...
            <br />
            <asp:Label ID="lblmessage" runat="server" Font-Bold="True" ForeColor="#FF3333" Text="No Vouchers Created Yet!"
                Visible="False" Width="244px"></asp:Label><br />
            <br />
            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                Font-Size="14pt" ForeColor="Blue" NavigateUrl="~/voucher/vouPrintMain.aspx">Back</asp:HyperLink></span></strong></div>
    </form>
</body>
</html>
