...
public partial class Discharge2511_English : System.Web.UI.Page
{
    public long polno;
    public string MOF;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                {
                    dthReqObj.readSql(dthrefSel);
                    OracleDataReader dthrefReader = dthReqObj.oraComm.ExecuteReader();
                    while (dthrefReader.Read())
                    {
                ...
                OracleDataReader oraDtReader = dthReqObj.oraComm.ExecuteReader();
