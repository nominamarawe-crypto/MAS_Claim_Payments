<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChildProtRev001.aspx.cs" Inherits="OldChildProt_ChildProtRev001" %>
        ...
        <table style="font-size: 12pt; width: 603px; font-family: 'Trebuchet MS'">
            ...
            <tr>
                <td colspan="4" style="height: 22px; background-color: #ffffff; text-align: center">
                    ...
                    </span>Outstanding Child Protect Reverse</strong></td>
            </tr>
            <tr>
                <td colspan="4" style="height: 22px; background-color: #f0f0f0">
                </td>
            ...
            <tr>
                ...
                <td style="width: 220px; height: 22px; background-color: #ffffff; text-align: left">
                    <asp:Button ID="btnsubmit" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                        OnClick="btnsubmit_Click" PostBackUrl="~/OldChildProt/ChildProtRev002.aspx" Text="Submit"
                        Width="106px" />
