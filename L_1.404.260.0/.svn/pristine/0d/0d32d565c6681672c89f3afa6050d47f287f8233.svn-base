<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cvouDetEdit010.aspx.cs" Inherits="cvouDetEdit010" %>
<%@ PreviousPageType VirtualPath ="~/ChildProt/cvouDetEdit001.aspx" %>
...
<body>
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><span style="font-size: 14pt">Sri Lanka
            Insurance<br />
        </span>Child Protection Vouchers Edit</span></strong><br />
        <br />
