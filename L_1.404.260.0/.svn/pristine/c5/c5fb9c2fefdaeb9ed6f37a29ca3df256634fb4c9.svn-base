...
public partial class reinsLetter003 : System.Web.UI.Page
{
   ...
   private int missingprems;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (PreviousPage != null && PreviousPage.IsCrossPagePostBack)
        {
            ...
            liability = this.PreviousPage.Liability;
            recovr = this.PreviousPage.Recovr;
            amtsto = this.PreviousPage.Amtsto;
            copy1 = this.PreviousPage.Copy1;
            copy2 = this.PreviousPage.Copy2;
            copy3 = this.PreviousPage.Copy3;
            copy4 = this.PreviousPage.Copy4;
            gender = this.PreviousPage.Gender;
            dob = this.PreviousPage.Dob;
            recovrby = this.PreviousPage.Recovrby;
            reinsperno = this.PreviousPage.Reinsperno;
            reinsshare = this.PreviousPage.Reinsshare; 
        }
        dm = new DataManager();
        try 
        {
            ...
            if (dm.existRecored(LPOLHIScheck) != 0)
            {
                ...
                OracleDataReader polhisReader = dm.oraComm.ExecuteReader();
            ...
            else { throw new Exception("No Terminated Police Details Found!"); }
            #endregion
            ...
            else { throw new Exception("No Death Reference Details!"); }
            ...
            this.lblrecover.Text = recovr;
            this.lblamtsto.Text = amtsto;
