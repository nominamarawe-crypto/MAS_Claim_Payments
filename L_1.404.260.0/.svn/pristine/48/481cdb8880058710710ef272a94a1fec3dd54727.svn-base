...
/// <summary>
/// Summary description for DthRegOut
/// </summary>
[Serializable()]
public class DthRegOut
{
    ...
    private List<DthRegOut> dthRegOutlistMaker = new List<DthRegOut>();
    public void Fetch(int Thestartdate, int Theenddate)
    {
        ...
        try
        {
            ...
            string dthrefsel = "select  drpolno,drmos,drclmno, drgrossclm, drnetclm from lphs.dthref where   (MEMOAPRV='N' or MEMOAPRV is null)  and  DENTDT  between " + startdate + "  and " + enddate + "";
            if (dm.existRecored(dthrefsel) != 0)
            {
                ...
                while (dthrefreader.Read())
                {
                    ...
                    noofClaims = DthRegOutListMake.Count + 1;
                    //TotalLiableAmt += totliableamt;
                    A.TOTLiabeAmt = TotalLiableAmt;
                    DthRegOutListMake.Add(A);
    ...
    public List<DthRegOut> DthRegOutListMake
    {
        get { return dthRegOutlistMaker; }
        set { dthRegOutlistMaker = value; }
    }
    public int Polno
    {
        get { return polno; }
