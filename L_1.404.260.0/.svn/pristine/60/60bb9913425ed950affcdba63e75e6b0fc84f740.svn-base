...
public partial class secondReq001 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                string secreqSelect = "select A.DRCOVTYP, B.DREQDSESCENG " +
                                      "from LPHS.DREQ a, LPHS.DREQDESC b " +
                ...
                if (formObj.existRecored(secreqSelect) != 0)
                {
                    ...
                    {
                        txtSecReqDescription.Text = "In order to process this claim pleases send us the following documents.";
                    }
                    else if (secReqFound)
                    {
                        txtSecReqDescription.Text = "Additional to above requirements please send us the following documents.";
                    }
    ...
    private void CreateDynTable(string reqcode, string req, int rowNumber, int RecordNumber)
    {
        ...
        //{
            ...
            //        nomName = "<span style='font-family:Arial; font-size:12px;'>" + nomName + "</span>";
            //    }
            ...
            if (RecordNumber == 31)
            {
                ...
                req = req.Replace("firstDt", frstReqDt);
                req = req.Replace("nomCunt", nomCount);
                req = req.Replace(".....", nomName);
                lbl2.Text = req;
            }
        ...
        //}
            if (RecordNumber == 23)
            {
                Session["Req23"] = req + "<br /><li style='margin-left:15px;'>The revised insurance premium applicable to continue the spouse cover will be informed to you from our policy holder’s service section in due course.</li>";
            }
        //if (RecordNumber == 24)
        //{
        //    if (Address1 != null)
    ...
    private void printCopy(ArrayList prtCpy)
    {
        ...
        foreach (ArrayList prtArr in prtCpy)
        {
            ...
            if (printCount == 1)
            {
                printToName = "<span style='margin-left:15px'>" + printName + "</span><br/>";
            }
            else
            {
