...
public partial class letters_CoveringLetter_MinimuthuEnglish002 : System.Web.UI.Page
{
    private bool signatureDisplay;
    private bool IsDeferent;
    private int val;
    private int Chckedbtn;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Ltdue.Text = Request.QueryString["dueYear"];
        //LtDate.Text = Request.QueryString["dateOfBefore"];
        if (!IsPostBack)
        {
            ...
            LtBranch.Text = Convert.ToString(PreviousPage.BrName);
            if (this.PreviousPage.TXT1 != "")
            {
                LtText.Text = this.PreviousPage.TXT1;
            }
        }
