<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vouDetEdit010.aspx.cs" Inherits="vouDetEdit010" %>
<%@ PreviousPageType VirtualPath="~/vouDetEdit001.aspx"%>
...
<body style="text-align: center">
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><span style="font-size: 14pt">Sri Lanka
            Insurance<br />
        </span>Surrender Voucher DetailsEdit</span></strong><br />
