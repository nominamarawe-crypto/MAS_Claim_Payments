<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateDeathRegister001.aspx.cs" Inherits="UpdateDeathRegister001" %>
...
<body>
    ...
    <div style="text-align: center">
        <span style="font-family: Trebuchet MS"><strong><span style="font-size: 14pt">
            ...
            Insurance<br />
                        </span>Manual Update Death Claim Register</td>
                </tr>
                <tr>
                ...
                <tr style="font-size: 12pt">
                    ...
                    <td style="width: 166px; height: 21px; text-align: left">
                        <span style="font-weight: normal; font-size: 10pt">Life Type</span></td>
                    <td style="width: 220px; height: 21px; text-align: left">
                        <span style="font-size: 12pt">
                            <asp:DropDownList ID="ddlMOS" runat="server" Font-Names="Trebuchet MS" Font-Size="10pt" AutoPostBack="true">
                 ...
                 <tr>
                    ...
                    <td style="text-align: left; height: 21px;" colspan="2">
                        <span>
                            <asp:TextBox ID="txtClaimNo" runat="server" MaxLength="8" Font-Names="Trebuchet MS" Font-Size="10pt"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtClaimNo"
                            ErrorMessage="Please Enter a Claim Number" Font-Bold="False" Font-Size="10pt"
                            Width="203px" Display="Dynamic"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td colspan="2" style="height: 21px; background-color: #ffffff; text-align: left">
                        <asp:Button ID="btnsubmit" runat="server" Font-Bold="False" 
                            Font-Names="Trebuchet MS" Text="--Submit--" Width="98px" 
