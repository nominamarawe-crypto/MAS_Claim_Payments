<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemoAprv001.aspx.cs" Inherits="MemoAprv001" %>
            ...
            <tr>
                ...
                <td style="width: 220px; height: 22px; background-color: #ffffff; text-align: left">
                    <asp:Button ID="btnsubmit" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                        OnClick="btnsubmit_Click" PostBackUrl="~/dthPay020.aspx" Text="Submit" Width="106px" />
