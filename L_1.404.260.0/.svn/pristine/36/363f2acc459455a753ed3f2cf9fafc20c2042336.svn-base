<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cvouAuth003.aspx.cs" Inherits="cvouAuth003" %>
<%@ PreviousPageType VirtualPath="~/ChildProt/cvouauth002.aspx"%>
...
<body>
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><span style="font-size: 14pt">Sri Lanka
            Insurance<br />
        </span>Child Protection Annual Payment Voucher<br />
            <table style="font-size: 10pt; width: 649px; font-family: Arial; font-variant: normal">
                <tr>
                    ...
                    <td colspan="4" style="height: 18px">
                        ...
                        VOUCHER FOR <span style="font-family: Trebuchet MS">ANNUAL </span>PAYMENT OF CHILD PROTECTION</p>
                    </td>
                </tr>
                <tr>
                    <td style="width: 10px; height: 18px">
                ...
                <tr>
                    ...
                    HAS BEEN DULY PERFORMED RENDERED.<?xml namespace="" ns="urn:schemas-microsoft-com:office:office"
                            prefix="o" ?><?xml namespace="" prefix="O" ?><?xml namespace="" prefix="O" ?><?xml
                                namespace="" prefix="O" ?><?xml namespace="" prefix="O" ?><?xml namespace="" prefix="O" ?><o:p></o:p></td>
                </tr>
                <tr>
                    <td style="width: 10px; height: 18px">
                    </td>
                    ...
                    <td colspan="5" style="height: 18px">
                        <span style="font-family: Courier New">
                            <asp:Button ID="btnauthorize" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                                OnClick="btnok_Click" OnClientClick="cForm1(this.form1)"
                                Text="Authorize" PostBackUrl="~/voucher/vouReprint004.aspx" /><asp:Button ID="btnexit" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
