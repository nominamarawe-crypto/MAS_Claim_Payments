...
public partial class letters_minimuthudischgsin001 : System.Web.UI.Page
{
    private int polno;
    private int clmno;
    private int paydue;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (polno != 0 && clmno != 0)
            {
                ...
                //amtsin = readamtsinobj.readAmountSinhala(amtwords, "remsh,a", "Y;");
        ...
        this.lblAmt.Text = String.Format("{0:N}", dueamt);
        this.lblDuedate.Text = paydue.ToString().Substring(0,4)+"/"+paydue.ToString().Substring(4,2)+"/"+COM.ToString().Substring(6,2);
        this.lblAmtword.Text = amtsin;
        this.lblFirstlife.Text = flife.ToString();
        this.lblSecondlife.Text = child.ToString();
        //this.lblNomname.Text = child.ToString();
