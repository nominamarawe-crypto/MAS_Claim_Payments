...
/// <summary>
/// Summary description for DthRepudiated
/// </summary>
[Serializable()]
public class DthRepudiated
{
    ...
    private List<DthRepudiated> dthRepudiatedlistMaker = new List<DthRepudiated>();
    public void Fetch(int Thestartdate, int Theenddate)
    {
        ...
        try
        {
            ...
            string dthrefsel = "select  drpolno,drmos,drclmno, drgrossclm, drnetclm, EXGRACIA_AMOUNT  from lphs.dthref where drpolno in (select POLICYNO from lphs.dth_repudiation)  and completed='R'  and  DENTDT  between " + startdate + "  and " + enddate + "";
            if (dm.existRecored(dthrefsel) != 0)
            {
                ...
                {
                    DthRepudiated A = new DthRepudiated();
                    ...
                    noofClaims = DthRepudiatedListMake.Count + 1;
                    //TotalLiableAmt += totliableamt;
                    A.TOTLiabeAmt = TotalLiableAmt;
                    DthRepudiatedListMake.Add(A);
    ...
    public List<DthRepudiated> DthRepudiatedListMake
    {
        get { return dthRepudiatedlistMaker; }
        set { dthRepudiatedlistMaker = value; }
    }
    public int Polno
    {
        get { return polno; }
