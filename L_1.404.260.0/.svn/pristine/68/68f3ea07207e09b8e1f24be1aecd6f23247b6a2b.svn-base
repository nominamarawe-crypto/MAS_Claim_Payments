<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RepudiatnLetter001.aspx.cs" Inherits="RepudiatnLetter001" %>
    ...
    <div style="text-align: center">
        <table style="width: 637px; font-size: 10pt; font-family: 'Trebuchet MS';">
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="3" style="height: 16px; text-align: center; font-size: 11pt;">
            ...
            <tr style="font-weight: bold; font-size: 14pt; text-decoration: underline">
                ...
                <td colspan="3" style="font-weight: normal; height: 8px; text-align: left; text-decoration: none; font-size: 10pt;">
                    <span>Date :</span><asp:Literal ID="litdate" runat="server"></asp:Literal></td>
            </tr>
            ...
            <tr style="font-weight: bold; font-size: 14pt; text-decoration: underline">
                <td style="font-weight: normal; font-size: 11pt; width: 15px; height: 6px; text-decoration: none">
                </td>
                <td colspan="3" style="font-weight: normal; font-size: 10pt; width: 15px; height: 6px;
                    text-align: left; text-decoration: none">
                    <asp:Literal ID="litname" runat="server"></asp:Literal></td>
            </tr>
            <tr style="font-weight: bold; font-size: 14pt; text-decoration: underline">
                <td style="font-weight: normal; font-size: 11pt; width: 15px; height: 5px; text-decoration: none">
                </td>
                <td colspan="3" style="font-weight: normal; font-size: 10pt; width: 15px; height: 5px;
                    text-align: left; text-decoration: none">
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="3" style="height: 8px; text-align: left; font-size: 10pt;">
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="3" style="height: 10px; text-align: left">
                    <p class="MsoNormal" style="margin: 0in 0in 0pt; font-size: 10pt;">
                        Dear Sir/Madam,</p>
                </td>
            </tr>
            <tr style="font-size: 12pt">
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="3" style="height: 10px; text-align: left">
                    <span style="mso-fareast-font-family: 'Times New Roman';
                        mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA; font-weight: bold; font-size: 11pt;">
                        <span><strong style="font-size: 11pt; font-family: 'Trebuchet MS';">Policy No:</strong></span><asp:Literal
                            ID="litpolno" runat="server"></asp:Literal></span></td>
            </tr>
            <tr style="font-size: 12pt">
                <td style="width: 15px; height: 11px">
                </td>
                <td colspan="3" style="height: 11px; text-align: left">
                    <span style="font-family: 'Trebuchet MS'; mso-fareast-font-family: 'Times New Roman';
                        mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA; font-weight: bold; font-size: 11pt;">
                        <span style="font-size: 11pt; font-family: Trebuchet MS"><strong style="font-size: 11pt; font-family: 'Trebuchet MS';">On the Life of </strong></span>
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="3" style="height: 10px; text-align: justify">
                    <span style="font-size: 10pt; mso-fareast-font-family: 'Times New Roman';
                        mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">
                        <strong style="font-weight: normal; font-size: 10pt; text-decoration: none">We refer
                            to the claim submitted under the above policy.</strong></span></td>
            </tr>
            ...
            <tr style="font-weight: bold; font-size: 14pt">
                ...
                <td colspan="3" style="height: 10px; text-align: justify">
                    <span style="font-weight: normal; font-size: 10pt;
                        text-decoration: none; mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US;
                        mso-fareast-language: EN-US; mso-bidi-language: AR-SA">According to our documents
                        it is observed that 
                        <asp:Literal ID="litrepureason" runat="server"></asp:Literal>
                        In Such
                            Incident no claim would
                            be paid.</span></td>
            </tr>
            ...
            <tr style="font-weight: bold; font-size: 10pt">
                ...
                <td colspan="3" style="height: 8px; text-align: justify">
                    <span style="font-weight: normal;
                        ...
                        mso-bidi-language: AR-SA">Therefore we regret to inform you that we are reluctantly
                        compelled to disclaim liability under this policy and no payment will be made.</span></td>
            </tr>
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="2" style="height: 10px; text-align: left">
                    <p class="MsoNormal" style="margin: 0in 0in 0pt">
                        <?xml namespace="" prefix="ST1" ?><?xml namespace="" prefix="ST1" ?><st1:country-region></st1:country-region><st1:place></st1:place><b style="mso-bidi-font-weight: normal"><span style="font-size: 10pt">SRI LANKA INSURANCE CORPORATION LIFE LTD</span></b></p>
                </td>
                <td style="width: 84px; height: 10px; text-align: left">
                </td>
            </tr>
            ...
            <tr style="font-size: 12pt">
                ...
                <td style="width: 84px; height: 7px; text-align: left">
                </td>
            </tr>
            <tr style="font-size: 12pt">
                <td style="width: 15px; height: 10px">
                ...
                <td colspan="2" style="height: 10px; text-align: left">
                    <p class="MsoNormal" style="margin: 0in 0in 0pt">
                        <b style="mso-bidi-font-weight: normal"><span style="font-size: 10pt">For Life Manager.<?xml namespace="" prefix="O" ?><o:p></o:p></span></b></p>
                </td>
                <td style="width: 84px; height: 10px; text-align: left">
                </td>
            </tr>
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="1" style="width: 74px; height: 10px; text-align: left; font-size: 10pt;">
                    <asp:Literal ID="litCopyto" runat="server" Text="Copy To :"></asp:Literal></td>
                <td colspan="2" style="height: 10px; text-align: left; font-size: 10pt;">
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="2" style="font-size: 10pt; height: 10px; text-align: left">
                    <asp:Literal ID="litagtad1" runat="server"></asp:Literal><asp:Literal ID="litagtad2" runat="server"></asp:Literal><asp:Literal ID="litagtad3" runat="server"></asp:Literal><asp:Literal ID="litagtad4" runat="server"></asp:Literal></td>
            </tr>
            <tr>
                <td style="width: 15px; height: 10px">
                </td>
