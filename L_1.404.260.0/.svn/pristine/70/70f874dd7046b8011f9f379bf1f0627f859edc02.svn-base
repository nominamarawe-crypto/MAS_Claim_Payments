...
public partial class cvouDetEdit002 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                {
                    dm.oraConn.Dispose();
                    throw new Exception("No Voucher Details Availbale or Voucher Already Printed or Voucher Already Authorized!"); 
                }
                ...
                if (dm.existRecored(voubankdetSel) != 0)
                {
                    ...
                    if (SLIACCTNO.Equals("000000000962")) { this.ddlslicacctno.SelectedIndex = 2; }
                }
                else
                {
                    BNKNAME = "";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                string TEMP_CBupdate = "update CASHBOOK.TEMP_CB set hname = '" + hname + "', hname1 = '" + hname2 + "', add1 = '" + ADD1 + "', " +
                    " add2 = '" + ADD2 + "',add3 = '" + ADD3 + "', add4 = '" + ADD4 + "'  where vouno = '" + vouno + "' ";
