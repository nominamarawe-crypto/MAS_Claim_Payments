...
public partial class intOfDeath2503Eng002 : System.Web.UI.Page
{
    ...
    public ArrayList AssuNameChange2 = new ArrayList();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (PreviousPage != null && PreviousPage.IsCrossPagePostBack)
        {
            ...
            ReqList = this.PreviousPage.REQUIREMENTLIST;
            AssuNameChange2 = this.PreviousPage.AssureandNomineeChanged2;
            ...
            try
            {
                ...
                if (formObj.existRecored(nomiselect) != 0)
                {
                    ...
                    while (nomireader.Read())
                    {
                        ...
                        if (!nomireader.IsDBNull(3)) { Address1.Add(nomireader.GetString(3)); nom.Add(nomireader.GetString(3)); } else { Address1.Add(""); nom.Add(""); }
               ...
               // }
                ...
                while (dreqreader.Read())
                {
                    ...
                    //    //if (reqcode == 9)
                    //    //{
                    //    //    reqdesc = reqdesc.Substring(0, 51) + " " + deathCertName + " " + reqdesc.Substring(80, 55) + " " + poldocname + " " + reqdesc.Substring(175, (reqdesc.Length - 175));
                    //    //}
                    //}
                    //dreqreader02.Close();
                ...
                { litreq23.Text = Session["Req23"].ToString(); litreq23new.Text = Session["Req23_2"].ToString(); litreq23new.Visible = true; }
            ...
            if (RecordNumber == 19 || RecordNumber == 20 || RecordNumber == 21)
            {
                ...
                if (RecordNumber == 20)
                {
                    for (int i = 0; i < NomChg.Count; i++)
                    {
                        ...
                        Dynlbl1.ControlStyle.Font.Size = 10;
                        Dynlbl1.Width = 10;
                        Dynlbl1.Style["margin-left"] = "30px";
                        tc.Controls.Add(Dynlbl1);
                        tr.Cells.Add(tc);
