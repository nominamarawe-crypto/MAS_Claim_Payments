<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeathRegisterAll.aspx.cs" Inherits="TEST2" %>
...
<body>
    ...
    <div>
    <h3>Death Register All</h3>
        <asp:GridView ID="GridViewDeathRegisterView" runat="server" EnableSortingAndPagingCallbacks="True" OnPageIndexChanging="GridViewDeathRegisterView_PageIndexChanging1" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" PageSize="20">
