...
public partial class dthVou001 : System.Web.UI.Page
{
    private long polno;
    private string MOS = "";
        ...
        if (!Page.IsPostBack)
        {
            try
            {
                ...
                if (polno == 0)
                {
                    ...
                    if (Request.QueryString["mos"] != null) { MOS = Request.QueryString["mos"].ToString(); }
                    //dthPay002 dthpay002obj = new dthPay002();
                    //polno = dthpay002obj.Polno;
                    //MOS = dthpay002obj.mOF;
                }
