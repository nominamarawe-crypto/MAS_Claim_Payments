...
public partial class secondReq002Sin : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ChechedBtn == 2)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=Second_Requirment_Letter_Sinhala_" + polno + ".doc");
