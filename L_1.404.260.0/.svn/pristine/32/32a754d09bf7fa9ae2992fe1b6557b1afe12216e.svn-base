...
<%@ PreviousPageType VirtualPath="~/letters/docsIntimation001.aspx"%>
        ...
        <table style="width: 531px">
            ...
            <tr>
                <td colspan="3" style="width: 371px; height: 18px; text-align: center">
                    <asp:LinkButton ID="linkEngDocMain" runat="server" PostBackUrl="~/letters/docsSinMain.aspx">Sinhala Documents</asp:LinkButton></td>
                <td colspan="2" style="width: 246px; height: 18px; text-align: center">
                    <asp:LinkButton ID="linkEngMain" runat="server" OnClick="linkEngMain_Click" PostBackUrl="~/letters/docsEngMain.aspx">English Documents</asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td colspan="3" style="width: 371px; height: 18px; background-color: #f0f0f0; text-align: left">
