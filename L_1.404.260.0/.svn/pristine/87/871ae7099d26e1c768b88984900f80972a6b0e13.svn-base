<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nomDetEnt01.aspx.cs" Inherits="nomDetEnt01" %>
    ...
    <div style="text-align: center">
        ...
        <table style="font-weight: bold; width: 651px; text-align: center; font-size: 10pt; font-family: 'Trebuchet MS';">
            ...
            <tr>
                ...
                <td colspan="2" style="height: 20px; text-align: left">
                    :-
                    <asp:TextBox ID="txtNomNum" runat="server" MaxLength="2" Width="51px" ReadOnly="True"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 20px; height: 19px; background-color: #f0f0f0">
                </td>
                <td style="height: 19px; background-color: #f0f0f0" colspan="3">
                    &nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4" style="height: 20px">
                    &nbsp;<asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Text="  Add  " Font-Bold="True" Font-Names="Trebuchet MS" />
                    <asp:Button ID="btnUpd" runat="server" Text="Update/Delete" OnClick="btnUpd_Click" PostBackUrl="~/nomDetEnt02.aspx" CausesValidation="False" Font-Bold="True" Font-Names="Trebuchet MS" />
                    <asp:Button ID="btnshares" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                         PostBackUrl="~/paymentDistn001.aspx" Text="Shares" OnClick="btnshares_Click" />
                    <asp:Button ID="btnExit" runat="server" OnClientClick="self.close()"
            ...
            <tr>
                ...
                <td style="height: 20px; text-align: center" colspan="3">
                    <asp:Label ID="lblnommessage" runat="server" ForeColor="#0000CC" Text="Existing Nominees"></asp:Label></td>
            </tr>
            <tr>
                <td style="width: 20px; height: 20px">
                </td>
                <td style="height: 20px; text-align: left" colspan="3">
                    <asp:Table ID="Table2" runat="server" HorizontalAlign="Left" Width="614px">
                    </asp:Table>
                </td>
            </tr>
            <tr>
