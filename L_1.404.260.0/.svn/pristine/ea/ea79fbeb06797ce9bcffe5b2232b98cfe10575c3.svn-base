...
public partial class vouDetEdit003 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                this.ddlslicacctno.Items.Add(new ListItem("0001092995", "0001092995"));
                this.ddlslicacctno.Items.Add(new ListItem("000000000962", "000000000962"));
                ...
                string temp_cbSelect = "select HNAME, HNAME1, TOTAMOUNT, ACNO, VOUDATE, " +
                    ...
                    " from CASHBOOK.TEMP_CB where vouno = '" + vouno + "' and PRINT1=0 and AUTHORIZED=0";
                ...
                if (dm.existRecored(temp_cbSelect) != 0)
                {
                    ...
                    this.txtad4.Text = ADD4;
                    this.txtNamewithins.Text = RECIPIENT_NAME;
                }
                else
                {
                    dm.connclose();
                    throw new Exception("No Voucher Details Availbale or Cheque Already Printed!");
                }
                ...
                if (dm.existRecored(voubankdetSel) != 0)
                {
                    ...
                    if (SLIACCTNO.Equals("0001092995")) { this.ddlslicacctno.SelectedIndex = 2; }
                    if (SLIACCTNO.Equals("000000000962")) { this.ddlslicacctno.SelectedIndex = 3; }
                }
                else
                {
                    BNKNAME = "";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try 
        {
            ...
            string ADD4 = this.txtad4.Text.ToString().Trim();
            string ACNUM = this.ddlslicacctno.SelectedItem.Value.ToString();
            CUSTACCTNO = this.txtcustAcct.Text;
            bdb = new BankDetailsBreak(BKNAM, BKBRN, CUSTACCTNO, NAMEPAYEE1);

            string hname = bdb.Hname1;
            string hname1 = bdb.Hname2;
            RECIPIENT_NAME = this.txtNamewithins.Text;
            ...
            {
                string TEMP_CBupdate = "update CASHBOOK.TEMP_CB set hname = '" + hname + "', hname1 = '" + hname1 + "', add1 = '" + ADD1 + "', " +
                    " add2 = '" + ADD2 + "', add3 = '" + ADD3 + "', add4 = '" + ADD4 + "', RECIPIENT_NAME='" + RECIPIENT_NAME + "', ACNO='" + ACNUM + "' where vouno = '" + vouno + "' ";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        name = this.txtpayeename.Text;
        insname = gg.NameWithInitials(name);
        txtNamewithins.Text = insname;
    }
}
