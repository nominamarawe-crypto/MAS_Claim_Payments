...
public partial class DeathRegisterCompleted : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SetDateRange();
        string SubString = "  where (dconfdat between " + fromDate + " and  " + toDate + ") and (completed = 'Y' or completed = 'R' ) ORDER BY dconfdat ASC,DRCLMNO ASC ";
