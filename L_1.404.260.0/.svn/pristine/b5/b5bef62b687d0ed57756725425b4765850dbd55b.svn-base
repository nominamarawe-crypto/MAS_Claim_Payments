<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecvouPrint002.aspx.cs" Inherits="cvouPrint002" %>
                    ...
                    <td colspan="5" style="height: 18px">
                        <span style="font-family: Courier New">
                            <asp:Button ID="btnprint" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                                OnClick="btnprint_Click" OnClientClick="cForm1(this.form1)"
                                Text=" Print " PostBackUrl="~/ChildProt/RecvouPrint003.aspx" /><asp:Button ID="btnexit" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
