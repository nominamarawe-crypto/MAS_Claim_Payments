<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cvouDetEdit001.aspx.cs" Inherits="cvouDetEdit001" %>
...
<body>
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><span style="font-size: 14pt">Sri Lanka
            Insurance<br />
        </span>Child Protection Annual Payment Voucher Details Edit<br />
        </span></strong>
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="3" style="height: 21px; background-color: #f0f0f0; text-align: left">
                    ...
                    <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="test"
                        ...
                        Font-Bold="False" Font-Size="10pt" Width="249px" Display="Dynamic"></asp:CustomValidator></td>
            </tr>
            <tr style="font-size: 12pt">
                <td style="width: 57px; height: 21px;">
                </td>
                <td colspan="2" style="height: 21px">
                    <asp:Button ID="btnsubmit" runat="server" Font-Bold="False" Font-Names="Trebuchet MS"
                        OnClick="btnsubmit_Click" Text="--Submit--" ValidationGroup="sb" Font-Size="10pt" Width="108px" />
