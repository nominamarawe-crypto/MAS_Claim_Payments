<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cvouReprint003.aspx.cs" Inherits="cvouReprint003" %>
<%@ PreviousPageType VirtualPath="~/childProtVou/cvouReprint002.aspx"%>
    ...
    <form id="form1" runat="server">
        <table style="font-size: 10pt; width: 649px; font-family: Arial; font-variant: normal">
            ...
            <tr style="font-size: 8pt">
                ...
                <td style="width: 1002px; height: 18px; text-align: left">
                    <span>NET AMOUNT PAYABLE RS.</span></td>
                <td style="width: 161px; height: 18px; text-align: left">
