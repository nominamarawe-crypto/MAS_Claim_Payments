<%@ Page Language="C#" AutoEventWireup="true" CodeFile="childProtPay002.aspx.cs" Inherits="childProtPay002" %>
            ...
            <tr style="font-size: 12pt">
                <td colspan="4" style="height: 18px">
                    <asp:Button ID="Button1" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                        OnClick="Button1_Click" Text="Create Voucher" /><asp:Button ID="btnnext" runat="server" Font-Bold="True" Font-Names="Trebuchet MS"
                        PostBackUrl="~/childProtVou/cvouPrint001.aspx" Text=" Next " OnClick="btnnext_Click" Width="128px"  />
