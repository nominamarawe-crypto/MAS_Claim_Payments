...
public partial class docsGScertnamediffEng002 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (PreviousPage != null)//&& PreviousPage.IsCrossPagePostBack
        {
            ...
            name1 = this.PreviousPage.Name1;
            name2 = this.PreviousPage.Name2;
            name3 = this.PreviousPage.Name3;
        }
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                this.litname1.Text = name1;
                this.litname2.Text = name2;
                this.litname3.Text = name3;
