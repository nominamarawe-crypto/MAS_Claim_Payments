...
public partial class letters_CoveringLetter_MinimuthuEnglish001 : System.Web.UI.Page
{
    int INDEX = 0;
    string LANG = "";
    private int polno;
    private long dob, nomdob,age=0,nomAge=0;
    private string MOF, seclife;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["lifeType"] != null)
            MOF = Request.QueryString["lifeType"].Trim();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        txt1 = TxtText.Text.Trim();
        brname = TxtBranch.Text.Trim();

        Server.Transfer("~/letters/CoveringLetter-MinimuthuEnglish002.aspx", true);
    }
}
