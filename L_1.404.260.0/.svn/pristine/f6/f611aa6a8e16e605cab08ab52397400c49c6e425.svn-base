...
<body>
    ...
    <div style="text-align: center">
        ...
        <table style="font-weight: bold; font-size: 12pt; width: 501px; font-family: Trebuchet MS">
            ...
            Insurance<br />
                    </span>Loan Voucher Authorization</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 912px; height: 21px;">
                </td>
                <td style="width: 256px; text-align: left; height: 21px;">
            ...
            <tr style="font-size: 12pt">
                <td style="width: 912px; height: 21px; background-color: #f0f0f0">
                </td>
            ...
            <tr style="font-size: 12pt">
                ...
                <td colspan="2" style="height: 21px; background-color: #ffffff; text-align: left">
                    <asp:Button ID="btnsubmit" runat="server" Font-Bold="False" Font-Names="Trebuchet MS"
                         PostBackUrl="~/vouAuth010.aspx" Text="--Submit--" Font-Size="10pt" Width="118px" />
            ...
            <tr style="font-size: 12pt">
                <td style="width: 912px; height: 20px; background-color: #f0f0f0">
                </td>
                <td style="width: 256px; height: 20px; background-color: #f0f0f0">
                </td>
                <td style="width: 220px; height: 20px; background-color: #f0f0f0; text-align: right">
                    </td>
                <td style="width: 79px; height: 20px; background-color: #f0f0f0">
                </td>
            </tr>
            <tr style="font-size: 12pt">
                <td style="width: 912px; height: 21px;">
