...
public partial class intOfDeath2503Tam : System.Web.UI.Page
{
    private int polno;
    private string MOF;
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                while (dreqreader.Read())
                {
                    ...
                    //{
                    //    this.createDynamicClmFormTable(r_row.ToString(), reqdesc, r_row, reqcode);
                    //    this.createDynamicEnclosedTable(r_row.ToString(), reqSrtdesc, r_row, reqcode);
                    //    r_row++;
                    ...
                    //else
                    //{
                    //    this.createDynamicOthDocTable(r_row.ToString(), reqdesc, r_row, reqcode);
                    //    r_row++;
                    //}
                ...
                if ((autoReq.getPolicyStatus(formObj, polno) == 2) || (autoReq.getPolicyStatus(formObj, polno) == 3 && MOF == "S"))
                {
                    ...
                    otherDesc2.InnerText = ",t; ,og;gPl;bid nray;Kiwg;gLj;Jtjw;F fPo; Nfhug;gLk; Njitg;ghLfis je;JjTkhW jho;ikAld;Nfl;Lf;nfhs;fpd;Nwhk;.";
                }
                else
                {
                    desc1.Visible = true;
                    ...
                    otherDesc2.InnerText = "Vida Mtzq;fs;.%yg;gpujp (,r; rhd;wpjo;fspd; epow;gpujpfs; Vw;Wf;nfhs;sg;glkhl;lhJ)";
                }
            }
            catch (Exception ex)
            {
        ...
        for (int a = 0; a < ReqcodeList.Count; a++)
        {
            if (int.Parse(ReqcodeList[a].ToString()) == 19)
            {
                for (int i = 0; i < 7; i++)
                {
                    ...
                    txtname2 = (TextBox)tblOtherDocs.FindControl("DyTextBox9" + i.ToString());
                    if (txtname2.Text != "")
                    {
            ...
            if (int.Parse(ReqcodeList[a].ToString()) == 20)
            {
                ...
                {
                    TextBox txtname2 = new TextBox();
                    txtname2 = (TextBox)tblOtherDocs.FindControl("DyTextBox10" + i.ToString());
                    if (txtname2.Text != "")
                    {
            ...
            if (int.Parse(ReqcodeList[a].ToString()) == 21)
            {
                for (int j = 0; j < 2; j++)
                {
                    ...
                    {
                        TextBox txtname2 = new TextBox();
                        txtname2 = (TextBox)tblOtherDocs.FindControl("DyTextBox20" + j.ToString() + i.ToString());
                        if (txtname2.Text != "")
                        {
                            if (j == 0)
                            {
