...
public partial class reminder004 : System.Web.UI.Page
{
    private  long polno;
    private  string MOF;
    public int sentDate;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (reminderObj.existRecored(dthintSelect) != 0)
                    {
                        ...
                        this.litEPF.Text = DeathClaimNumber.ToString();
                        if (AddressList1[0].ToString() != "")
                        {
                            CopyToArray.Add(AddressList1);
                        }
                ...
                if (reminderObj.existRecored(BranchAddressSelect) != 0)
                {
                    ...
                    while (dthintReader.Read())
                    {
                        ...
                        AddressList2.Add(""); AddressList2.Add("BR ADMIN");
                        if (AddressList2[0].ToString() != "")
                        {
                            CopyToArray.Add(AddressList2);
                        }
                    }
                }
                ...
                if (AGENCY != 0)
                {
                    ...
                    if (reminderObj.existRecored(InsuranceOffAddressSelect) != 0)
                    {
                        ...
                        while (dthintReader.Read())
                        {
                            ...
                            AddressList3.Add(AGENCY); AddressList3.Add("AG COPY");
                            if (AddressList3[0].ToString() != "")
                            {
                                CopyToArray.Add(AddressList3);
                            }
                        }
                    }
                    #endregion
                    ...
                    else
                    {
                        ...
                        if (reminderObj.existRecored(Br_SM_Address) != 0)
                        {
                            ...
                            while (odr.Read())
                            {
                                if (!odr.IsDBNull(0)) { AddressList3.Add(odr.GetString(0).Trim()); }
                                else { AddressList3.Add(""); }
                                if (!odr.IsDBNull(1)) { AddressList3.Add(odr.GetString(1)); }
                                else { AddressList3.Add(""); }
                                if (!odr.IsDBNull(2)) { AddressList3.Add(odr.GetString(2)); }
                                else { AddressList3.Add(""); }
                                if (!odr.IsDBNull(3)) { AddressList3.Add(odr.GetString(3)); }
                                else { AddressList3.Add(""); }
                                if (!odr.IsDBNull(4)) { AddressList3.Add(odr.GetString(4)); }
                                else { AddressList3.Add(""); }
                                if (!odr.IsDBNull(5)) { AddressList3.Add(odr.GetString(5)); }
                                else { AddressList3.Add(""); }
                                AddressList3.Add("SM COPY");
                                if (AddressList3[0].ToString() != "")
                                {
                                    CopyToArray.Add(AddressList3);
                                }
                ...
                if (reminderObj.existRecored(Region_Cor_Select) != 0)
                {
                    ...
                    while (dthintReader.Read())
                    {
                        if (!dthintReader.IsDBNull(0)) { AddressList4.Add(dthintReader.GetString(0)); }
                        else { AddressList4.Add(""); }
                        if (!dthintReader.IsDBNull(1)) { AddressList4.Add(dthintReader.GetString(1)); }
                        else { AddressList4.Add(""); }
                        if (!dthintReader.IsDBNull(2)) { AddressList4.Add(dthintReader.GetString(2)); }
                        else { AddressList4.Add(""); }
                        if (!dthintReader.IsDBNull(3)) { AddressList4.Add(dthintReader.GetString(3)); }
                        else { AddressList4.Add(""); }
                        if (!dthintReader.IsDBNull(4)) { AddressList4.Add(dthintReader.GetString(4)); }
                        else { AddressList4.Add(""); }
                        AddressList4.Add(""); AddressList4.Add("RG COD");
                        if (AddressList4[0].ToString() != "")
                        {
                            CopyToArray.Add(AddressList4);
                        }
                    }
                }
                ...
                if (reminderObj.existRecored(Region_Sm_Select) != 0)
                {
                    ...
                    while (dthintReader.Read())
                    {
                        if (!dthintReader.IsDBNull(0)) { AddressList5.Add(dthintReader.GetString(0)); }
                        else { AddressList5.Add(""); }
                        if (!dthintReader.IsDBNull(1)) { AddressList5.Add(dthintReader.GetString(1)); }
                        else { AddressList5.Add(""); }
                        if (!dthintReader.IsDBNull(2)) { AddressList5.Add(dthintReader.GetString(2)); }
                        else { AddressList5.Add(""); }
                        if (!dthintReader.IsDBNull(3)) { AddressList5.Add(dthintReader.GetString(3)); }
                        else { AddressList5.Add(""); }
                        if (!dthintReader.IsDBNull(4)) { AddressList5.Add(dthintReader.GetString(4)); }
                        else { AddressList5.Add(""); }
                        AddressList5.Add(""); AddressList5.Add("RG SM");
                        if (AddressList5[0].ToString() != "")
                        {
                            CopyToArray.Add(AddressList5);
                        }
                    }
                }
                ...
                string dreqSelect = "select drcovtyp, drrema, DRSENTDT from lphs.dreq where drpol=" + polno + " and drtyp='" + MOF + "' and (drrecdt=0 or drrecdt is null) and DRSENTDT >0 and (REMINDERDT = 0 or REMINDERDT is null)";
                if (reminderObj.existRecored(dreqSelect) != 0)
                {
                    ...
                    {                       
                        ...
                        {
                            arr.Add(new reminderDocset2(rowNum, reqcode, sentDate, remarks));
                            rowNum++;
                        }
                    }
                    dreqreader.Close();
                ...
                else 
                {
                    ...
                    if (reminderObj.existRecored(dreqSelect2) != 0)
                    {
                        ...
                        {                           
                            ...
                            if (yeardiff > 0 || mnthdiff > 0 || dawasdiff > 14)
                            {
                                arr.Add(new reminderDocset2(rowNum, reqcode, remindersentdate, remarks));
                                rowNum++;
                            }
                        }
                        dreqreader.Close();
                    ...
                    else
                    {
                        ...
                        if (reminderObj.existRecored(dreqSelect3) != 0)
                        {
                            ...
                            {                               
                                ...
                                {
                                    arr.Add(new reminderDocset2(rowNum, reqcode, secondremsentdt, remarks));
                                    rowNum++;
                                }
                            }
                            dreqreader.Close();
                ...
                int count = 0;
                foreach (reminderDocset2 req in arr)
                {
                    count++;
                ...
                if (Rem_no == 1)
                {
                    lblremi_no.Text = "m%:u isysle|jSuhs";
                }
                if (Rem_no == 2)
                {
                    lblremi_no.Text = "fojk isysle|jSuhs";
                }
                if (Rem_no == 3)
                {
                    lblremi_no.Text = "f;jk isysle|jSuhs";
                }
            }
            catch (Exception ex)
            {
            ...
            if (Chckedbtn == 2)
            {
                ...
                Response.AppendHeader("Content-disposition", "attachment; filename=" + polno + "_reminder.doc");
        ...
        if (RecordNumber == 24)
        {
            ...
            if (Address1 != null)
            {
                if (Address1.Count != 0)
                {
                    ...
                    litreq21.Text = reqDesc + " ";
                    litnomname.Text = Nominees;
                    litreq2.Text = "jsiska iuzmqrAK l,hq;=h'";
                }
            }
        }
    }
