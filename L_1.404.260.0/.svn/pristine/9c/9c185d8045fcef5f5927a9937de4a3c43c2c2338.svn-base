<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vouAuth010.aspx.cs" Inherits="vouAuth010" %>
<%@ PreviousPageType VirtualPath="~/vouAuth001.aspx"%>
...
<body style="text-align: center">
    ...
    <div style="text-align: center">
        <strong><span style="font-family: Trebuchet MS"><span style="font-size: 14pt">Sri Lanka
            Insurance<br />
        </span>Surrender Voucher Authorization</span></strong><br />
