<%@ Page Language="C#" AutoEventWireup="true" CodeFile="moreLegalHires001.aspx.cs" Inherits="moreLegalHires001" %>
        ...
        <table style="width: 568px">
            ...
            <tr>
                ...
                <td colspan="4" style="text-align: center">
                    <span style="font-family: Trebuchet MS"><strong>Add More Legal Hires</strong></span></td>
                <td style="width: 19px">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <strong style="border-right: fuchsia 1px solid; border-top: fuchsia 1px solid; border-left: fuchsia 1px solid;
                    ...
                    <span style="font-size: 10pt; font-family: Trebuchet MS"><span style="color: #990099">
                        Balance Share : </span>
                        <asp:Label ID="lblBalanceshare" runat="server" Text="20%" ForeColor="#C000C0"></asp:Label></span></strong></td>
                <td style="width: 19px">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="height: 26px; text-align: right;">
                    <span style="font-size: 10pt; font-family: Trebuchet MS">Share Amount</span></td>
                <td style="height: 26px; text-align: left;">
            ...
            <tr>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                                runat="server" ControlToValidate="txtShare" ErrorMessage="Please Enter Share Amount"
            ...
            <tr>
                ...
                <td colspan="3" style="text-align: left">
                    <asp:TextBox ID="txtName" runat="server" Width="430px"></asp:TextBox></td>
                <td style="width: 19px">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="4" style="height: 21px; text-align: center;">
                    <asp:Label ID="lblMessage" runat="server" Text="Share Exceeds Balance!" Font-Bold="True" Font-Names="Trebuchet MS" ForeColor="#FF3300" Visible="False"></asp:Label></td>
                <td style="width: 19px; height: 21px">
                </td>
            </tr>
            <tr>
                ...
                <td style="height: 26px; text-align: center;" colspan="4">
                    <span style="font-size: 10pt; font-family: Trebuchet MS">
                        ...
                        <asp:Button ID="cmdMore" runat="server" Height="25px" Text="-More-" Width="75px" Enabled="False" OnClick="cmdMore_Click" />
                        <asp:Button ID="cmdNext" runat="server" Height="25px" Text="-Next-" Width="75px" OnClick="cmdNext_Click" />&nbsp;</span></td>
                <td style="width: 19px; height: 26px;">
                </td>
            </tr>
            <tr>
