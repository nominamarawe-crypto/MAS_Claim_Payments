<%@ Page Language="C#" AutoEventWireup="true" CodeFile="secondReq002Sin.aspx.cs"
    Inherits="secondReq002Sin" %>

<%@ PreviousPageType VirtualPath="~/secondReq001Sin.aspx" %>
...
<body >
    ...
    <%       
     ...
     <div id="printDiv" style="text-align: center; width: 640px; background-color: white; padding: 0px 0px; padding-left: 40px; margin-right: auto; margin-left: auto">
        <table style="font-weight: normal; font-size: 10pt; font-family: Sandaya;">
             <tr>
           ...
           <%-- <tr>
            ...
            <tr>
                <td style="height: 10px; padding-top: 5px;" colspan="5" class="sinhalaWord tableTextAlign">
                    by; wxl orK „ú; rlaIK Tmamqj hgf;a mek ke.S we;s urK ysñlu iïnkaOfhka Tn úiska tjk
                    ,o f,aLK wmfj; ,eî we;'
                </td>
            </tr>
            <asp:Panel ID="pnlPendingReq" runat="server" Visible="false">
                <tr>
                    <td style="height: 10px; padding-top: 5px;" colspan="5" class="sinhalaWord tableTextAlign">
                        ...
                        oske;s wmf.a ,smsh u.ska leojd we;s my; ioyka wjYH;d fuf;la wm fj; bosrsm;a lr fkdue;'
                        tneúka tu wjYH;djhka fkdmudj wm fj; bosrsm;a lrk f,i okajd isáuq'
                    </td>
                </tr>
                <tr>
                    <td style="height: 10px; padding-top: 5px;" colspan="5" class="tableTextAlign">
                        <asp:Table ID="tblFirstReq" CssClass="sinhalaWord" runat="server">
                        </asp:Table>
                    </td>
                </tr>
            </asp:Panel>
            <asp:Panel ID="pnlSecReq" runat="server" Visible="false">
                <tr>
                    <td style="height: 10px; padding-top: 5px;" colspan="5" class="tableTextAlign sinhalaWord">
                        <asp:Label ID="txtSecReqDescription" CssClass="tableTextAlign" runat="server"></asp:Label>
                        <%--;jo fuu ysñlu iïnkaOfhka bosrs lghq;= lsrSu i|yd my; ioyka wjYH;do wm fj; ,nd fok
                        fuka ldreKslj okajd isáuq'--%>
                    </td>
                </tr>
                <tr>
                    <td style="height: 10px; padding-top: 5px;" colspan="5" class="tableTextAlign">
                        <asp:Table ID="tblSecReq" CssClass="sinhalaWord" runat="server">
                        </asp:Table>
                    </td>
                </tr>
                <asp:Panel ID="pnlNom" runat="server" Visible="false">
                    <tr>
                        <td style="height: 10px" colspan="5" class="tableTextAlign">
                            <asp:Label ID="lblSecondReq" CssClass="sinhalaWord" runat="server"></asp:Label>
                        </td>
                    </tr>
                </asp:Panel>
            </asp:Panel>
            ...
            <tr>
                <td style="height: 10px" colspan="5" class="tableTextAlign">
                <asp:Label ID="lblAddWord" runat="server"></asp:Label></td>
            </tr>
            </asp:Panel>
            <tr>
                <td style="height: 10px" colspan="5" class="tableTextAlign">
                    fuu wjYH;d fkdue;sj ysñlfuys bosrs lghq;= isoql, fkdyels nj ldreKslj i,lkak'
                </td>
            </tr>
            <tr>
                <td style="height: 10px" colspan="5" align="left">
            ...
            <tr>
                <td style="height: 10px" colspan="5" align="left">
                    YS% ,xld bkaIqjrkaia fldamfrAIka ,hs*a ,susgvz
                </td>
            </tr>
            <tr>
            ...
            <asp:Panel ID="pnlPrintCopy" runat="server" Visible="false">
                <tr>
                    <td style="height: 10px" align="left" colspan="5">
                        msgm; (<asp:Label ID="lblPrintCopy" CssClass="englishWord" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="height: 10px">
            ...
            <tr>
                <td style="height: 20px; font-size: 8pt;  border-bottom:none;" colspan="5" align="left">
                    <b>wmf.a oqrl:k wxl - 2357247 $ 2357225 $ 2357290 $ 2357252 $ 2357253 $ 2357205 $ 2357221</b>
                </td>
            </tr>
